        ...
        return [
            {
                ...
                "content": (
                    ...
                    "GUI subtasks are executed by a MobileWorld-style GUI executor; "
                    "plan app tasks so the executor can focus input fields before text entry, "
                    "submit search text explicitly, and avoid repeating failed action sequences. "
